...
struct ReaderView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .tzrFocusSearch)) { _ in
            session.sidebarTab = .search
            sidebarVisible = .all
            searchFocused = true
        }
        .onReceive(NotificationCenter.default.publisher(for: .tzrToggleSidebar)) { _ in
            sidebarVisible = (sidebarVisible == .detailOnly) ? .all : .detailOnly
        }
        .onReceive(NotificationCenter.default.publisher(for: .tzrShowDiagnostics)) { _ in
...
extension Notification.Name {
    static let tzrFocusSearch = Notification.Name("tzrFocusSearch")
    static let tzrToggleSidebar = Notification.Name("tzrToggleSidebar")
    static let tzrShowDiagnostics = Notification.Name("tzrShowDiagnostics")
}
