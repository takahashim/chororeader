...
struct AppCommands: Commands {
    ...
    var body: some Commands {
        ...
        CommandGroup(replacing: .textEditing) {
            Button("検索") { NotificationCenter.default.post(name: .tzrFocusSearch, object: nil) }
        ...
        CommandGroup(after: .help) {
            Button("この書籍の診断…") {
                NotificationCenter.default.post(name: .tzrShowDiagnostics, object: nil)
            }
        ...
        CommandGroup(after: .sidebar) {
            Button("サイドバーの表示を切り替え") {
                NotificationCenter.default.post(name: .tzrToggleSidebar, object: nil)
            }
